...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  android: {
    ...
    versionCode: 1,
    adaptiveIcon: {
      // Brand mark (assets from unigate.co, generated by scripts/brand — see docs/mobile-app.md); white, as the logo is multicolour.
  ...
  plugins: [
    ...
    [
      'expo-splash-screen',
      { backgroundColor: '#ffffff', image: './assets/images/splash-icon.png', imageWidth: 160 },
    ],
