/**
 * SHA-256 for browsers without `crypto.subtle` — which is only exposed in secure contexts
 * (HTTPS or localhost). Testers opening the portal over plain HTTP on a LAN address land here.
 * Straight FIPS 180-4; the result is byte-identical to the WebCrypto digest.
 */
